...
**Medium-Risk Yield Pool for TreasuryPilot System on Arc**

## Overview

YieldPoolModerate is a simulated medium-risk DeFi yield pool designed for the TreasuryPilot autonomous treasury management system. This contract represents a balanced lending strategy with moderate returns (5% APY).
